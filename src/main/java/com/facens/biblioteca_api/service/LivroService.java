...
@Service // Indica que esta classe é um componente de serviço, contendo a lógica de negócios da aplicação.
public class LivroService {
    ...
    } //this é um construtor que instancia "livroRepository"
